...
$.SmartMessageBox = function (o, t) {
  ...
  if (null != o.input) switch (a = 1, o.input = o.input.toLowerCase(), o.input) {
    ...
    case"password":
      ...
      break;
    case"select":
      if (null == o.options) alert("For this type of input, the options parameter is required."); else {
  ...
  e += "</div>", e += "</div>", e += "</div>", SmartMSGboxCount > 1 && ($(".MessageBoxContainer").hide(), $(".MessageBoxContainer").css("z-index", 99999)), $(".divMessageBox").append(e), 1 == a && $("#txt" + SmartMSGboxCount).focus(), $(".botTempo").hover(function () {
    ...
    var o = $(this).attr("id"), e = o.substr(o.indexOf("-") + 1), i = $.trim($(this).text());
    if (1 == a) {
      if ("function" == typeof t) {
        var s = e.replace("Msg", ""), n = $("#txt" + s).val();
        t && t(i, n)
      }
...
$.bigBox = function (o, t) {
  ...
  e = "<div id='bigBox" + (BigBoxes += 1) + "' class='bigBox animated fadeIn fast'><div id='bigBoxColor" + BigBoxes + "'><i class='botClose fa fa-times' id='botClose" + BigBoxes + "'></i>", e += "<span>" + o.title + "</span>", e += "<p>" + o.content + "</p>", e += "<div class='bigboxicon'>", null == o.icon && (o.icon = "fa fa-cloud"), e += "<i class='" + o.icon + "'></i>", e += "</div>", e += "<div class='bigboxnumber'>", null != o.number && (e += o.number), e += "</div></div>", e += "</div>", $("#divbigBoxes").append(e), null == o.color && (o.color = "#004d60"), $("#bigBox" + BigBoxes).css("background-color", o.color), $("#divMiniIcons").append("<div id='miniIcon" + BigBoxes + "' class='cajita animated fadeIn' style='background-color: " + o.color + ";'><i class='" + o.icon + "'/></i></div>"), $("#miniIcon" + BigBoxes).bind("click", function () {
    var o = $(this).attr("id"), t = o.replace("miniIcon", "bigBox"), e = o.replace("miniIcon", "bigBoxColor");
  ...
  if (null != o.colors && o.colors.length > 0 && (a.attr("colorcount", "0"), s = setInterval(function () {
    ...
    a.animate({backgroundColor: o.colors[t].color}), n.animate({backgroundColor: o.colors[t].color}), l.animate({backgroundColor: o.colors[t].color}), t < o.colors.length - 1 ? a.attr("colorcount", 1 * t + 1) : a.attr("colorcount", 0)
  }, o.colortime)), a.bind("click", function () {
    clearInterval(s), "function" == typeof t && t && t();
    var o = $(this).attr("id"), e = o.replace("botClose", "bigBox"), i = o.replace("botClose", "miniIcon");
...
function checkVersion() {
  var o = "You're not using Windows Internet Explorer.", t = getInternetExplorerVersion();
...
function isIE8orlower() {
  var o = "0", t = getInternetExplorerVersion();
...
$.smallBox = function (o, t) {
  ...
  null == o.color ? l.css("background-color", "#004d60") : l.css("background-color", o.color), null != o.colors && o.colors.length > 0 && (l.attr("colorcount", "0"), n = setInterval(function () {
    ...
    l.animate({backgroundColor: o.colors[t].color}), t < o.colors.length - 1 ? l.attr("colorcount", 1 * t + 1) : l.attr("colorcount", 0)
    ...
    0 != $("#" + a + ":hover").length ? $("#" + a).on("mouseleave", function () {
      ...
      $(".SmallBox").each(function (o) {
        0 == o ? ($(this).animate({top: 20}, 300), e = $(this).height() + 40, SmallBoxesAnchos = $(this).height() + 40) : ($(this).animate({top: e}, 350), e = e + $(this).height() + 20, SmallBoxesAnchos = SmallBoxesAnchos + $(this).height() + 20)
      })
    }) : (clearInterval(n), SmallBoxesAnchos -= o, "function" == typeof t && t && t(), $("#" + a).removeClass().addClass("SmallBox").animate({opacity: 0}, 300, function () {
      $(this).remove();
      var o = 0;
      $(".SmallBox").each(function (t) {
        0 == t ? ($(this).animate({top: 20}, 300), o = $(this).height() + 40, SmallBoxesAnchos = $(this).height() + 40) : ($(this).animate({top: o}), o = o + $(this).height() + 20, SmallBoxesAnchos = SmallBoxesAnchos + $(this).height() + 20)
      })
    }))
    ...
    SmallBoxesAnchos -= o, $(this).removeClass().addClass("SmallBox").animate({opacity: 0}, 300, function () {
      $(this).remove();
      var o = 0;
      $(".SmallBox").each(function (t) {
        0 == t ? ($(this).animate({top: 20}, 300), o = $(this).height() + 40, SmallBoxesAnchos = $(this).height() + 40) : ($(this).animate({top: o}, 350), o = o + $(this).height() + 20, SmallBoxesAnchos = SmallBoxesAnchos + $(this).height() + 20)
      })
    })
  })
};